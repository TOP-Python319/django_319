    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adds', models.IntegerField(db_column='Favorites', default=0, verbose_name='Добавления в избранное')),
                ('status', models.BooleanField(choices=[(False, 'не проверно'), (True, 'проверено')], default=0, verbose_name='Проверено')),
            ],
            options={
